...
ZohoForms.renderForm = function(form_meta) {//function for rendering the form from the meta data
    ...
    if(window.ZS_PreviewMode){
        if(parent.window.location.pathname.indexOf("builder")!=-1){
            html.push("<div><form elname=\"",form_meta.formLinkName,"\" name=\"",form_meta.formLinkName,"\" onsubmit=\"return false;\">");
        }else{
    ...
    html.push("<input type=\"hidden\" name=\"cdigest\" elName=\"zc-captcha-digest\" value=\"\"/>");
    ...
    for(i=0;(field = fields[i]);i++) {
        ...
        switch(field.Type) {
            ...
            case ZohoForms.CURRENCY:
                fnLabelElem(field, html);
                html.push("<div><span><input formcompid=\"",field.formcompid,"\" onchangeexists=\"",field.onChangeExists,"\" name=\"",field.FieldName,"\" fieldtype=\"",field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\" value=\"",(field.Initial)?fnAsString(field.Initial):"","\"",(field.formulaExists && field.formulaExists == true)?" isformulaexist=\"true\"":"",(field.MaxChar)?" maxlength=\""+field.MaxChar+"\"":"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":""," /><label>", field.CurrencyType, "</label></span></div>");
                break;
            case ZohoForms.PERCENTAGE:
                fnLabelElem(field, html);
                html.push("<div><span><input formcompid=\"",field.formcompid,"\" onchangeexists=\"",field.onChangeExists,"\" name=\"",field.FieldName,"\" fieldtype=\"",field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\" value=\"",(field.Initial)?fnAsString(field.Initial):"","\"",(field.MaxChar)?" maxlength=\""+field.MaxChar+"\"":"",(field.formulaExists && field.formulaExists == true)?" isformulaexist=\"true\"":"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":""," /><label>  % </label></span></div>");
                break;
            ...
            case ZohoForms.DATE:
                ...
                if(window.ZS_PreviewMode) {
                    ...
                    html.push("<button onclick=\"datepicker.show(this,'date',true,false)\" type=\"button\" for=\"dateEl-",fnAsString(field.DisplayName),"-",form_meta.formLinkName,"-",form_meta.recType,"\"class=\"dateinvoker\"></button></span></div>");
                }
                break;
            case ZohoForms.DATE_TIME:
                ...
                if(window.ZS_PreviewMode) {
                    ...
                    html.push("<button onclick=\"datepicker.show(this,'datetime',true,false)\" type=\"button\" for=\"dateEl-",fnAsString(field.DisplayName),"-",form_meta.formLinkName,"-",form_meta.recType,"\"class=\"dateinvoker\"></button></span></div>");
                }
                break;
            case ZohoForms.CHECK_BOX:
                html.push("<label>&nbsp;</label><div formcompid=\"",field.formcompid,"\" onchangeexists=\"\"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":"","><span><input id=\"",field.FieldName,"\"  formcompid=\"",field.formcompid,"\" onchangeexists=\"",field.onChangeExists,"\" fieldtype=\"",field.Type,"\" delugetype=\"",field.delugeType,"\" name=\"",field.FieldName,"\" type=\"checkbox\"",(field.Initial === "checked")?"checked":""," value=\"",fnAsString(field.DisplayName),"\" id=\"checkboxesEl_",fnAsString(field.DisplayName),"_",form_meta.recType,"\"/>");
                if(field.Reqd === true){
            ...
            case ZohoForms.CHECK_BOXES:
                ...
                if(field.Type == ZohoForms.PICK_LIST || field.Type == ZohoForms.LIST) {
                    html.push("<div><span><select formcompid=\"",field.formcompid,"\" onchangeexists=\"",field.onChangeExists,"\" fieldtype=\"",field.Type,"\" delugetype=\"",field.delugeType,"\" ",(field.Type == ZohoForms.LIST)?"type=\"multiselect\"":"type=\"picklist\""," name=\"",field.FieldName,"\" ",(field.Type == ZohoForms.LIST)?" multiple":"",(field.formulaExists && field.formulaExists == true)?" isformulaexist=\"true\"":"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":"",">");
                    if(field.Type == ZohoForms.PICK_LIST) 
                        html.push("<option>-Select-</option>");
                }else{
                    html.push("<div delugetype=\"",field.delugeType,"\" fieldtypeno=\"",field.Type,"\" fieldname=\"",field.FieldName,"\" fieldtype=\"",(field.Type == ZohoForms.RADIO)?"radio":"checkbox","\" formcompid=\"",field.formcompid,"\" onchangeexists=\"",field.onChangeExists,"\" isformulaexist=",(field.formulaExists && field.formulaExists == true)?"\"true\"":"\"\"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":"",">");
                }
            ...
            case ZohoForms.IMAGE :
                fnLabelElem(field, html);
                html.push("<div name=\"",field.FieldName,"\" type=\"image\">");
                html.push("<span><em>Source</em><input name=\"zcsource-",field.FieldName,"\" fieldtype=\"", field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":""," /></span>");//No I18N
                if(field.altTxtReq === true){
                    html.push("<span><em>Alt Text</em><input name=\"zcalttext-",field.FieldName,"\" fieldtype=\"", field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":""," /></span>");//No I18N
                }
                if(field.imgLinkReq === true){
                    html.push("<span><em>Link</em><input name=\"zcfieldlink-",field.FieldName,"\" fieldtype=\"", field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":""," /></span>");//No I18N
                }
                if(field.imgTitleReq === true){
                    html.push("<span><em>Title</em><input name=\"zctitle-",field.FieldName,"\" fieldtype=\"", field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":""," /></span>");//No I18N
                }
                html.push("<input name=\"zctarget-",field.FieldName,"\" fieldtype=\"", field.Type,"\" type=\"hidden\" value=\"new\"/></div>");
                break;
            case ZohoForms.URL :
                fnLabelElem(field, html);
                html.push(" <div name=\"",field.FieldName,"\" type=\"url\">"); 
                html.push("<span><em>URL</em><input name=\"zcurl-",field.FieldName,"\" fieldtype=\"", field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":""," /></span>");//No I18N
                if(field.urlLinkNameReq === true){
                    html.push("<span><em>Link Name</em><input name=\"zclnkname-",field.FieldName,"\" fieldtype=\"", field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\"",(field.Tooltip)?" title=\""+fnAsString(field.Tooltip)+"\"":""," /></span>");//No I18N
                }
                if(field.urlTitleReq === true){
                    html.push("<span><em>Title</em><input name=\"zctitle-",field.FieldName,"\" fieldtype=\"", field.Type,"\" delugetype=\"",field.delugeType,"\" type=\"text\"/></span>");//No I18N
                }
                html.push("<input name=\"zctarg-",field.FieldName,"\" fieldtype=\"", field.Type,"\" type=\"hidden\" value=\"new\"/></div>");
                break;
    ...
    if(captcha && captcha != ""){
        ...
        html.push("<div><span><input type=\"text\" style=\"width:150px;\" name=\"zc_captcha\"/></span></div>");
        html.push("<div><span><img elname=\"zc-captcha\"></span></div>");
        html.push("</li>");
    }
     ...
     if(buttons && buttons.length >0 ){
         html.push("<li><label>&nbsp;</label><div>");
         for(i=0;(button = buttons[i]);i++) {
            var button_type = (button.ButtonType == ZohoForms.SUBMIT) ? "submit" : "reset"; //NO I18N
            html.push("<input type=\""+button_type+"\" value=\"",fnAsString(button.DisplayName),"\">");
         }
         html.push("</div></li>");
     } else{
...
ZohoForms.fnCheckFormsInPage = function(formId,publishFlag){
    if(publishFlag){
        var formsList = $(".zpcontent-wrapper .form");
    }else{
        var canvasContWindow = $("#pagecanvas")[0].contentWindow;
        var formsList = canvasContWindow.$(".zpcontent-wrapper .form");    
    }
    for(var n=0; n<formsList.length; n++){
        var formElem = formsList[n];
        var formAlExist = formElem.querySelector("[name="+formId+"]");//NO I18N
        if(formAlExist != null){
            return true;
        }
    }
...
ZohoForms.loadCaptcha = function(formElement) {
    var captchaEl = formElement.querySelector("[elname='zc-captcha']"); //NO I18N
    if(captchaEl){
        var xmlhttp,
            formid = formElement.querySelector("input[name=formid]").getAttribute("value"), //NO I18N
        ...
        try{
            ...
            xmlhttp.onreadystatechange = function(){
                if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
                    ...
                    cdigest_element = formElement.querySelector("input[name=cdigest]"); //NO I18N
                    cdigest_element.value = cdigest;
                    captchaEl.src = captcha_url;    
                }            

            }
            xmlhttp.open("GET", "/siteforms/getcaptcha.do?time=" + time + "&formid=" + formid, true);
            xmlhttp.send();
        }catch(e){}
    }
}
...
// ------------------------- end : Form Renderer -------------------------------------//
//-------------------------- Start : Creator methods overwriting ------------------------------------- // 
var clearComponent=function(formName, fieldName, recType){
	var el = ZCForm.clearField(formName, fieldName, recType);
	if(!el){
		selEl=$("#"+formName+"-"+fieldName+"-"+recType+" div")[0];
		if(selEl && ((selEl.getAttribute("fieldtype")=="radio") || (selEl.getAttribute("fieldtype")=="checkbox"))){
			selEl.innerHTML="";
		}
	}
...
var addValueToTheFieldElem =function (formName, fieldName, value, recType, combinedValue, isAppend){
	var fieldElem = document.getElementById( formName + ":" + fieldName + "_recType_comp" );
	a=$("#"+formName+"-"+fieldName+"-"+recType+" div")[0];
	if(a){
		if((a.getAttribute("fieldtype")=="radio") || (a.getAttribute("fieldtype")=="checkbox")){

			sitesadd(formName, fieldName, value, a.getAttribute("fieldtype"), recType, a);
		}else{
...
var id=type+"El_"+fieldName+"_"+value+"_"+recType;//NO I18N
	var inputEl = $("<span><input id=\""+id+"\" name=\""+fieldName+"\" formcompid=\""+$(e).attr("formcompid")+"\"delugetype=\""+$(e).attr("delugetype")+"\" onchangeexists=\""+$(e).attr("onchangeexists")+"\"  fieldtype=\""+$(e).attr("fieldtypeno")+"\" value=\""+value+"\" isformulaexist=\""+$(e).attr("isformulaexist")+"\" type=\""+type+"\"/><label>"+value+"</label></span>");
	$(e).append(inputEl);
}

function docid(A){return document.getElementById(A)}
//-------------------------- End : Creator methods overwriting ------------------------------------- // 
//-------------------------- start : Date Picker ------------------------------------- // 
    ...
    for(var i=7; (td = tdArray[i]);i++) {
        ...
        if(/^day datePickerDay/.test(td.className)){
            ...
            if(showMonth == day1.getMonth() && i>=weekday){
                td.innerHTML = curDate = day1.getDate();
...
datepicker.show = function(invoker,mode, publishMode, blockPreviousDate){// showing the datepicker with the specified date selected
    var node;
    if(publishMode)
    ...
    this.mode = mode;
    this.blockPreviousDate = blockPreviousDate;
...
datepicker.submitDate=function(){// submitting the date and time selected to the input box
    ...
    if(!isNaN(datepicker.date)) {
        ...
        if(datepicker.blockPreviousDate && new Date()>newDate){
